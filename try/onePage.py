...
# 1.找到数据所对应的链接地址
url = 'https://sjz.lianjia.com/ershoufang/kaifaqu1/'
headers = {
...
for li in lis:
    ...
    print(title, address, introduce, star, startime, tags, totalPrice, unitPrice)
    # 往文件里追加数据
    # 4.数据的保存
    with open('二手房onePage.csv', mode='a', encoding='utf_8_sig', newline='') as csvfile:
